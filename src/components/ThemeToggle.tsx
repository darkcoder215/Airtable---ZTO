...
// Two-theme picker: dark (default) + light. Both are pure CSS-token
// swaps driven by data-theme on <html>; see globals.css for the
// token definitions. The user's choice persists in localStorage
// under the same key the original toggles used.
...
const VALID: ReadonlySet<Theme> = new Set(["dark", "light"]);
...
const THEMES: ThemeOption[] = [
  { key: "dark",  hint: "داكن",  Icon: Moon },
  { key: "light", hint: "فاتح",  Icon: Sun  },
];
...
export function ThemeToggle() {
  ...
  // below matches a "dark" render to avoid the well-known hydration
  // warning.
  useEffect(() => {
